...
const Header = () => {
  return (
    <header className="flex flex-row justify-between items-center absolute top-0 left-0 w-full px-4 pt-7 min-[390px]:px-6 md:pt-10 lg:px-12 min-[1440px]:px-20 min-[1440px]:py-12">
      <a href="#">
